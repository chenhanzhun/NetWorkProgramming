...
main(int argc, char *const *argv)
{
    ...
    ngx_cycle_t      *cycle, init_cycle;/* 初始化的主体结构 */
    ngx_core_conf_t  *ccf;              /* 保存上下文配置 */
    ...
    /* 全局变量init_cycle清零，即内存管理初始化，并创建改变量的内存池pool */
    ...
    /* 保存传入的命令行参数至全局变量ngx_os_argv、ngx_argc、ngx_argv */
    ...
    /* 遍历所有模块并初始化每个模块module的index，并计算ngx_max_module */
    ngx_max_module = 0;
